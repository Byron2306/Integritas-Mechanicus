...
ARDA_OS_ROOT = Path(__file__).resolve().parents[2]
...
def get_config():
    ...
    return {
        ...
        "covenant_chain_db": Path(os.environ.get(
            "ARDA_CHAIN_DB", str(base / "evidence" / "covenant_chain.db")
        )),
